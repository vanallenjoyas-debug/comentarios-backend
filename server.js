...
app.get('/fb/comments', async (req, res) => {
  try {
    ...
    let url = `https://graph.facebook.com/v19.0/${FB_PAGE_ID}/posts?fields=id,message,created_time,comments.limit(20){id,message,from,created_time,comments{id,from}}&limit=1&access_token=${FB_TOKEN}`;
